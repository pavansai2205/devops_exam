    ...
    return (
        ...
        <h1 style={{ textAlign: 'center' }}>Discover Your Perfect Outfit in Minutes</h1>
          ...
          <div className="text-center mt-4">
            <button className="btn btn-light px-4"onClick={() => props.set("mens")}>Buy</button>
            <a href="#" className="link-dark mx-3" onClick={() => props.set("about")}>Learn More</a>
          </div>
        </div>
        <div className="container px-4 py-5">
          ...
          <div className="row row-cols-1 row-cols-md-2 align-items-md-center g-5 py-5">
            <div className="col d-flex flex-column align-items-start gap-2">
              ...
              <a href="#" className="btn btn-outline-dark btn-md" onClick={() => props.set("about")}> Learn More</a>
            </div>
            <div className="col">
